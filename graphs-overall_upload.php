...
<?php
    echo "<center>";
    echo "<img src=\"library/graphs-overall-users-upload.php?type=" . htmlspecialchars($type, ENT_QUOTES) . "&user=" . htmlspecialchars($username, ENT_QUOTES) . "&size=" . htmlspecialchars($size, ENT_QUOTES) . "\" />";
    echo "</center>";
?>
	</div>
