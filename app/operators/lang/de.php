...
$l['maintenance'] = [
    'title' => 'Wartung offener Sitzungen',
    'history' => 'Abrechnungsverlauf löschen (alle Datensätze)',
    'help' => '<h2 class="fs-6">Vor dem Start</h2><p>Ein offener Abrechnungsdatensatz ist nicht zwangsläufig veraltet. Dieses Werkzeug prüft weder die Benutzeraktivität noch die Erreichbarkeit des NAS.</p><h2 class="fs-6">Aktionen</h2><ul><li><strong>Sitzungen schließen</strong> behält die erfasste Nutzung bei und markiert die ausgewählten Zeilen mit <code>Admin-Reset</code> als geschlossen. Benutzer werden dadurch nicht vom NAS getrennt.</li><li><strong>Datensätze löschen</strong> entfernt die ausgewählten offenen Zeilen und deren Nutzungsdaten dauerhaft.</li></ul><h2 class="fs-6">Umfang und Bestätigung</h2><p>Der Abgleich des Benutzernamens erfolgt exakt gemäß der Kollation der Datenbank. Ein Datum trifft Sitzungen, die vor dem Tagesbeginn dieses Datums in der Zeitzone der Abrechnungsdatenbank bzw. des Servers gestartet wurden.</p><p>Zeigen Sie jeden Vorgang vor der Bestätigung in der Vorschau an. Eine Vorschau enthält höchstens 100 Zeilen, läuft nach 10 Minuten ab und kann einmal verwendet werden. Geänderte oder nicht mehr zulässige Zeilen werden übersprungen.</p>',
    'close' => 'Sitzungen schließen',
    'delete' => 'Datensätze löschen',
    'details' => 'Details',
    'openWarning' => 'Offene Sitzungen können noch aktiv sein.',
    'openHelp' => 'Berechtigt sind nur Datensätze mit fehlender Stoppzeit oder einer historischen Stoppzeit mit dem Wert null. Eine Erkennung von Inaktivität wird nicht durchgeführt.',
    'dateHelp' => 'Der Datumsumfang bedeutet: Sitzungsstart VOR dem ausgewählten Datum, ausschließlich um 00:00:00 in der Zeitzone der Abrechnungsdatenbank bzw. des Servers (nicht in der Zeitzone Ihres Browsers). Dies ist keine Grenze für die letzte Aktivität.',
    'selectTitle' => 'Sitzungen auswählen',
    'closeSummary' => 'Abrechnungsdaten behalten und die ausgewählten Sitzungen als geschlossen markieren.',
    'deleteSummary' => 'Die ausgewählten offenen Abrechnungsdatensätze dauerhaft entfernen.',
    'closeHelp' => 'Die Datensätze werden jetzt mit dem manuellen Beendigungsgrund Admin-Reset geschlossen. Dadurch werden Benutzer nicht vom NAS getrennt. Die erfasste Dauer und die Datenverkehrszähler bleiben unverändert erhalten; künftige Abrechnungsaktualisierungen sind nicht garantiert.',
    'deleteHelp' => 'Das Löschen kann nicht rückgängig gemacht werden. Die erfasste Nutzung wird dauerhaft entfernt, und Berichte oder Nutzungssummen können sich ändern. Die Historie geschlossener Sitzungen wird durch dieses Werkzeug nicht gelöscht.',
    'scope' => 'Umfang auswählen',
    'username' => 'Benutzername',
    'date' => 'Sitzungsstart vor Datum',
    'value' => 'Benutzername oder Datum (YYYY-MM-DD)',
    'filterHelp' => 'Eine Änderung dieses Filters erfordert eine neue Vorschau.',
    'filterDetails' => 'Der Abgleich des Benutzernamens folgt der Sortierung der Abrechnungsdatenbank; eine Suche mit Platzhaltern wird nicht unterstützt.',
    'preview' => 'Übereinstimmende Datensätze in der Vorschau anzeigen',
    'previewTitle' => 'Vorschau',
    'previewDetails' => 'Vorschaudetails',
    'count' => '%d übereinstimmende Datensätze zum Zeitpunkt der Zählung; %d Datensätze in dieser Vorschau. Höchstens %d pro Vorgang, nach Abrechnungs-ID sortiert. Nur angezeigte Datensätze können geändert werden. Für ein weiteres Paket die Vorschau wiederholen; die Anzahl kann sich während der Abrechnungsaktualisierungen ändern.',
    'concurrency' => 'Die Bestätigung läuft nach 10 Minuten ab und kann nur einmal verwendet werden. Datensätze, die durch Interim-/Stop-Aktualisierungen geändert wurden oder nicht mehr berechtigt sind, werden übersprungen. Neu passende Datensätze werden diesem Vorgang niemals hinzugefügt.',
    'id' => 'Abrechnungs-ID',
    'nas' => 'NAS-Adresse',
    'start' => 'Sitzungsstart',
    'activity' => 'Erfasster Aktualisierungszeitpunkt',
    'seconds' => 'Erfasste Sekunden',
    'input' => 'Erfasste Eingangsbytes',
    'output' => 'Erfasste Ausgangsbytes',
    'activityHelp' => 'Der Aktualisierungszeitpunkt wird nur angezeigt, wenn das Abrechnungsschema acctupdatetime bereitstellt. Fehlende Werte werden als Gedankenstrich angezeigt. Diese Datenbankwerte belegen weder Inaktivität noch die Erreichbarkeit des NAS.',
    'closeSelectionOne' => '%d Sitzung ausgewählt',
    'closeSelectionMany' => '%d Sitzungen ausgewählt',
    'deleteSelectionOne' => '%d Datensatz ausgewählt',
    'deleteSelectionMany' => '%d Datensätze ausgewählt',
    'closeConfirmOne' => '%d Sitzung schließen',
    'closeConfirmMany' => '%d Sitzungen schließen',
    'deleteConfirmOne' => '%d Datensatz dauerhaft löschen',
    'deleteConfirmMany' => '%d Datensätze dauerhaft löschen',
    'empty' => 'Keine passenden offenen Datensätze. Es wurde nichts geändert.',
    'result' => '%s: %d tatsächlich betroffen, %d geänderte oder nicht mehr berechtigte Datensätze übersprungen, %d fehlgeschlagen. Vor jedem weiteren Vorgang erneut eine Vorschau anzeigen.',
    'invalid' => 'Ungültige Anfrage, ungültiger Filter oder CSRF-Token oder abgelaufene Bestätigung. Es wurde nichts geändert. Erstellen Sie eine neue Vorschau.',
    'error' => 'Abrechnungsdatensätze können nicht gelesen werden. Es wurde kein Vorgang ausgeführt.',
];
