...
$l['maintenance'] = [
    'title' => 'Manutenção de sessões abertas',
    'history' => 'Excluir histórico de contabilidade (todos os registros)',
    'help' => '<h2 class="fs-6">Antes de começar</h2><p>Um registro de contabilidade aberto não é necessariamente obsoleto. Esta ferramenta não verifica a atividade do usuário nem a conectividade do NAS.</p><h2 class="fs-6">Ações</h2><ul><li><strong>Fechar sessões</strong> mantém o uso registrado e marca as linhas selecionadas como fechadas com <code>Admin-Reset</code>. Isso não desconecta os usuários do NAS.</li><li><strong>Excluir registros</strong> remove permanentemente as linhas abertas selecionadas e seus dados de uso.</li></ul><h2 class="fs-6">Escopo e confirmação</h2><p>A correspondência do nome de usuário é exata de acordo com a collation do banco de dados. Uma data corresponde às sessões iniciadas estritamente antes da meia-noite dessa data no fuso horário do banco de dados/servidor de contabilidade.</p><p>Visualize cada operação antes de confirmá-la. Uma visualização contém no máximo 100 linhas, expira após 10 minutos e pode ser usada uma vez. Linhas alteradas ou que deixaram de ser elegíveis são ignoradas.</p>',
    'close' => 'Fechar sessões',
    'delete' => 'Excluir registros',
    'details' => 'Detalhes',
    'openWarning' => 'As sessões abertas ainda podem estar ativas.',
    'openHelp' => 'Somente registros com horário de parada ausente ou zero legado são elegíveis. Nenhuma detecção de inatividade é realizada.',
    'dateHelp' => 'O escopo por data significa INÍCIO DA SESSÃO ANTES da data selecionada, exclusivamente às 00:00:00 no fuso horário do banco de dados/servidor de contabilidade (não no fuso horário do seu navegador). Não é um limite da última atividade.',
    'selectTitle' => 'Selecionar sessões',
    'closeSummary' => 'Manter os dados de contabilidade e marcar as sessões selecionadas como fechadas.',
    'deleteSummary' => 'Remover permanentemente os registros de contabilidade abertos selecionados.',
    'closeHelp' => 'Os registros são fechados agora com a causa de término manual Admin-Reset. Isso não desconecta os usuários do NAS. A duração registrada e os contadores de tráfego são mantidos inalterados; futuras atualizações de contabilidade não são garantidas.',
    'deleteHelp' => 'A exclusão é irreversível. O uso registrado é removido permanentemente e os relatórios ou totais de uso podem mudar. O histórico fechado não é excluído por esta ferramenta.',
    'scope' => 'Selecionar escopo',
    'username' => 'Nome de usuário',
    'date' => 'Início da sessão antes da data',
    'value' => 'Nome de usuário ou data (YYYY-MM-DD)',
    'filterHelp' => 'Alterar este filtro exige uma nova visualização.',
    'filterDetails' => 'A correspondência do nome de usuário segue a collation do banco de dados de contabilidade; a pesquisa com curingas não é compatível.',
    'preview' => 'Visualizar registros correspondentes',
    'previewTitle' => 'Visualização',
    'previewDetails' => 'Detalhes da visualização',
    'count' => '%d registros correspondentes no momento da contagem; %d registros nesta visualização. Máximo de %d por operação, ordenados pelo ID de contabilidade. Somente os registros exibidos podem ser alterados. Faça uma nova visualização para outro lote; a contagem pode mudar durante as atualizações de contabilidade.',
    'concurrency' => 'A confirmação expira após 10 minutos e é de uso único. Registros alterados por atualizações Interim/Stop ou que não sejam mais elegíveis são ignorados. Registros que correspondam posteriormente nunca são adicionados a esta operação.',
    'id' => 'ID de contabilidade',
    'nas' => 'Endereço do NAS',
    'start' => 'Início da sessão',
    'activity' => 'Horário da atualização registrada',
    'seconds' => 'Segundos registrados',
    'input' => 'Bytes de entrada registrados',
    'output' => 'Bytes de saída registrados',
    'activityHelp' => 'O horário da atualização só é exibido se o esquema de contabilidade fornecer acctupdatetime. Valores ausentes são exibidos como um traço. Esses valores do banco de dados não comprovam inatividade nem conectividade do NAS.',
    'closeSelectionOne' => '%d sessão selecionada',
    'closeSelectionMany' => '%d sessões selecionadas',
    'deleteSelectionOne' => '%d registro selecionado',
    'deleteSelectionMany' => '%d registros selecionados',
    'closeConfirmOne' => 'Fechar %d sessão',
    'closeConfirmMany' => 'Fechar %d sessões',
    'deleteConfirmOne' => 'Excluir permanentemente %d registro',
    'deleteConfirmMany' => 'Excluir permanentemente %d registros',
    'empty' => 'Nenhum registro aberto correspondente. Nada foi alterado.',
    'result' => '%s: %d realmente afetados, %d registros alterados ou inelegíveis ignorados, %d falharam. Faça uma nova visualização antes de qualquer outra operação.',
    'invalid' => 'Solicitação, filtro, token CSRF ou confirmação expirada inválida. Nada foi alterado. Crie uma nova visualização.',
    'error' => 'Não é possível ler os registros de contabilidade. Nenhuma operação foi realizada.',
];
