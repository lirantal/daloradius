...
// for the DOMPDF www utility we use dbuser and dbpass
include_once(__DIR__ . "/../../includes/daloradius.conf.php");

define("DOMPDF_ADMIN_USERNAME", $configValues['CONFIG_DB_USER']);
define("DOMPDF_ADMIN_PASSWORD", $configValues['CONFIG_DB_PASS']);
