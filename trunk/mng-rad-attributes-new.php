...
//	include('library/check_operator_perm.php');
	...
	if (isset($_POST["submit"])) {
		...
		isset($_REQUEST['RecommendedOP']) ? $RecommendedOP = $_REQUEST['RecommendedOP'] : $RecommendedOP = "";
		isset($_REQUEST['RecommendedTable']) ? $RecommendedTable = $_REQUEST['RecommendedTable'] : $RecommendedTable = "";
		isset($_REQUEST['RecommendedTooltip']) ? $RecommendedTooltip = $_REQUEST['RecommendedTooltip'] : $RecommendedTooltip = "";
