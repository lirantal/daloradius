...
* comparison of hotspots per average time of users spent logged-in *
*                                                                  *
...
$graph->title->Set("Average Time (in sec) users spent logged-in per Hotspot");
