...
if (!window.DHTML_SUITE_THEME_IMAGES_FOLDER)var DHTML_SUITE_THEME_IMAGES_FOLDER = './images';
if (!window.DHTML_SUITE_THEME_FOLDER)var DHTML_SUITE_THEME_FOLDER = './css/';
...
// {{{ init()
     ...
     */
    init: function () {
        this.imagePath = DHTML_SUITE_THEME_IMAGES_FOLDER;
// Path to images
        this.cssPath = DHTML_SUITE_THEME_FOLDER;
// Path to images
