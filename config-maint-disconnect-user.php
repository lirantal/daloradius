...
<div id="contentnorightbar">
    ...
    <h2 id="Intro"><a href="#"
                      onclick="javascript:toggleShowDiv('helpPage')"><?php echo $l['Intro']['configmaintdisconnectuser.php'] ?>
            <h144>+</h144>
        </a></h2>
        ...
        <div class="tabber">
            ...
            <div class="tabbertab" title="<?php echo $l['title']['Settings']; ?>">
                ...
                <fieldset>
                    ...
                    <select onChange="javascript:setStringTextMulti(this.id,'nasaddr','nassecret')" id='naslist'
                            tabindex=103
                            class='form'>
			...
			/** Making usernameSearch interactive **/
	              ...
	              autoComSearch.add('usernameSearch','include/management/dynamicAutocomplete.php','_small','getAjaxAutocompleteUsernames');
                    ...
                    <input type='submit' name='submit' value='<?php echo $l['button']['DisconnectUser'] ?>'
                           class='button'/>
            ...
            <div class="tabbertab" title="<?php echo $l['title']['Advanced']; ?>">
                ...
                <fieldset>
                    ...
                    <img src="images/icons/bullet_arrow_up.png" alt="+"
                         onclick="javascript:changeInteger('timeout','increment')"/>
                    <img src="images/icons/bullet_arrow_down.png" alt="-"
                         onclick="javascript:changeInteger('timeout','decrement')"/>
                    <br/>
                    ...
                    <img src="images/icons/bullet_arrow_up.png" alt="+"
                         onclick="javascript:changeInteger('retries','increment')"/>
                    <img src="images/icons/bullet_arrow_down.png" alt="-"
                         onclick="javascript:changeInteger('retries','decrement')"/>
                    <br/>
                    ...
                    <img src="images/icons/bullet_arrow_up.png" alt="+"
                         onclick="javascript:changeInteger('count','increment')"/>
                    <img src="images/icons/bullet_arrow_down.png" alt="-"
                         onclick="javascript:changeInteger('count','decrement')"/>
                    <br/>
                    ...
                    <img src="images/icons/bullet_arrow_up.png" alt="+"
                         onclick="javascript:changeInteger('requests','increment')"/>
                    <img src="images/icons/bullet_arrow_down.png" alt="-"
                         onclick="javascript:changeInteger('requests','decrement')"/>
                    <br/>
