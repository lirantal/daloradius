...
<?php
    ...
    $sql = "SELECT ".$configValues['CONFIG_DB_TBL_RADACCT'].".RadAcctId, ".$configValues['CONFIG_DB_TBL_DALOHOTSPOTS'].".name as hotspot, ".$configValues['CONFIG_DB_TBL_RADACCT'].".UserName, ".$configValues['CONFIG_DB_TBL_RADACCT'].".FramedIPAddress, ".$configValues['CONFIG_DB_TBL_RADACCT'].".AcctStartTime, ".$configValues['CONFIG_DB_TBL_RADACCT'].".AcctStopTime, ".$configValues['CONFIG_DB_TBL_RADACCT'].".AcctSessionTime, ".$configValues['CONFIG_DB_TBL_RADACCT'].".AcctInputOctets, ".$configValues['CONFIG_DB_TBL_RADACCT'].".AcctOutputOctets, ".$configValues['CONFIG_DB_TBL_RADACCT'].".AcctTerminateCause, ".$configValues['CONFIG_DB_TBL_RADACCT'].".NASIPAddress FROM ".$configValues['CONFIG_DB_TBL_RADACCT']." LEFT JOIN ".$configValues['CONFIG_DB_TBL_DALOHOTSPOTS']." ON ".$configValues['CONFIG_DB_TBL_RADACCT'].".calledstationid = ".$configValues['CONFIG_DB_TBL_DALOHOTSPOTS'].".mac WHERE NASIPAddress='".$dbSocket->escapeSimple($nasipaddress)."' ORDER BY $orderBy $orderType LIMIT $offset, $rowsPerPage;";
	$res = $dbSocket->query($sql);
	$logDebugSQL = "";
	$logDebugSQL .= $sql . "\n";
	...
	echo "<thread> <tr>
		<th scope='col'>
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=radacctid&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['ID']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=hotspot&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['HotSpot']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=username&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['Username']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=framedipaddress&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['IPAddress']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=acctstarttime&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['StartTime']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=acctstoptime&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['StopTime']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=acctsessiontime&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['TotalTime']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=acctinputoctets&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['Upload']." (".$l['all']['Bytes'].")</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=".urlencode($nasipaddress)."&orderBy=acctoutputoctets&orderType=".urlencode($orderTypeNextPage)."\">"
        .$l['all']['Download']." (".$l['all']['Bytes'].")</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=". urlencode($nasipaddress) . "&orderBy=acctterminatecause&orderType=" . urlencode($orderTypeNextPage) . "\">"
        .$l['all']['Termination']."</a>
		</th>
		<th scope='col'> 
		<br/>
		<a class='novisit' href=\"" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "?nasipaddress=" . urlencode($nasipaddress) . "&orderBy=nasipaddress&orderType=" . urlencode($orderTypeNextPage) . "\">"
